...
try:
	c1 = pd.read_csv('/Users/qiming/Desktop/AirbnbProject/dataset/detailed_listing/listings_BST.csv',low_memory=False)
	c2 = pd.read_csv('/Users/qiming/Desktop/AirbnbProject/dataset/detailed_listing/listings_LA.csv',low_memory=False)
	c3 = pd.read_csv('/Users/qiming/Desktop/AirbnbProject/dataset/detailed_listing/listings_NYC.csv',low_memory=False)
	c4 = pd.read_csv('/Users/qiming/Desktop/AirbnbProject/dataset/detailed_listing/listings_SEA.csv',low_memory=False)
	c5 = pd.read_csv('/Users/qiming/Desktop/AirbnbProject/dataset/detailed_listing/listings_CHI.csv',low_memory=False)
	c6 = pd.read_csv('/Users/qiming/Desktop/AirbnbProject/dataset/detailed_listing/listings_SF.csv',low_memory=False)
...
if __name__ == '__main__':
	...
	try:
		combined.to_csv('/Users/qiming/Desktop/detailed_listing.csv',index=False,header=False)
	except IOError:
